package com.sm.borutoapp.presentation.components
...
import com.sm.borutoapp.ui.theme.EXTRA_SMALL_PADDING
import com.sm.borutoapp.ui.theme.LightGray
import com.sm.borutoapp.ui.theme.StarColor
...
fun calculateStars(rating: Double) : Map<String,Int> {
    ...
    LaunchedEffect(key1 = rating){
        ...
        }else{ Log.d("rating" , "Invalid rating number.") }
    }
